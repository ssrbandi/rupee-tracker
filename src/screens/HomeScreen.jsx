...
const s = {
  container:    { minHeight: '100vh', background: '#0f0f13', fontFamily: "'DM Sans', sans-serif", paddingBottom: 40 },
  header:       { padding: '48px 20px 16px', background: 'linear-gradient(160deg, #1a1a2e, #16213e)', borderBottom: '1px solid #ffffff12' },
  headerTop:    { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 },
  label:        { fontSize: 10, letterSpacing: 3, color: '#888' },
  signOutBtn:   { background: 'transparent', border: '1px solid #ffffff15', color: '#666', borderRadius: 8, padding: '4px 12px', fontSize: 12, cursor: 'pointer' },
  balanceVal:   { fontSize: 36, fontWeight: 700, letterSpacing: -1 },
  balanceInput: { fontSize: 32, fontWeight: 700, background: 'transparent', border: 'none', borderBottom: '2px solid #a78bfa', color: '#fff', outline: 'none', width: 200 },
  tapHint:      { fontSize: 10, color: '#444' },
  ...
  pillName:     { fontSize: 11, color: '#ccc' },
  pillAmt:      { fontSize: 11, fontWeight: 600 },
  tabBar:       { display: 'flex', overflowX: 'auto', padding: '0 8px', background: '#13131a', borderBottom: '1px solid #ffffff10', gap: 2, paddingTop: 6 },
  ...
  addTabBtn:    { whiteSpace: 'nowrap', padding: '8px 14px', background: 'transparent', border: 'none', color: '#555', fontSize: 14, cursor: 'pointer', borderBottom: '2px solid transparent' },
  ...
  addEntryBtn:  { border: 'none', borderRadius: 8, padding: '8px 16px', fontSize: 13, fontWeight: 700, cursor: 'pointer', color: '#000' },
  deleteTabBtn: { background: 'transparent', border: '1px solid #ff000030', color: '#ff6b6b80', borderRadius: 8, padding: '8px 12px', fontSize: 12, cursor: 'pointer' },
  entryRow:     { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 14px', background: '#16161f', borderRadius: 12, marginBottom: 8, border: '1px solid #ffffff08' },
  entryLeft:    { display: 'flex', alignItems: 'center', gap: 10 },
  entrySign:    { fontSize: 18, fontWeight: 700, width: 16 },
  entryLabel:   { fontSize: 14, color: '#fff', fontWeight: 500 },
  entryDate:    { fontSize: 11, color: '#555', marginTop: 2 },
  entryAmt:     { fontSize: 15, fontWeight: 700 },
  delBtn:       { background: 'transparent', border: 'none', color: '#444', cursor: 'pointer', fontSize: 18 },
  overlay:      { position: 'fixed', inset: 0, background: '#000000cc', display: 'flex', alignItems: 'flex-end', zIndex: 100 },
  sheet:        { background: '#1e1e2e', borderRadius: '20px 20px 0 0', padding: 24, width: '100%', maxWidth: 480, margin: '0 auto', paddingBottom: 40 },
  ...
  fieldInput:   { width: '100%', background: '#ffffff0d', border: '1px solid #ffffff15', borderRadius: 10, padding: '12px 14px', color: '#fff', fontSize: 14, outline: 'none', boxSizing: 'border-box' },
  typeBtn:      { flex: 1, padding: '10px', borderRadius: 10, fontSize: 14, fontWeight: 600, cursor: 'pointer' },
  sheetBtn:     { width: '100%', border: 'none', borderRadius: 12, padding: 14, fontWeight: 700, fontSize: 15, cursor: 'pointer', color: '#000' },
}